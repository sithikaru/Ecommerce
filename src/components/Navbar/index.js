                ...
                <div className="flex md:order-2 gap-2">
                    ...
                    }
                    {
                        user?.role === "admin" && isAuthuser?
                            !isadminView ? <button className={styles.button}>Admin View</button> : <button className={styles.button}>Client View</button>
                            : null
                    }
                    {
                        isAuthuser ?
                            <button className={styles.button}>Logout</button> : <button className={styles.button}>Login</button>
                    }
                    <button 
                    data-collapse-toggle="navbar-sticky"
                    type="button"
                    className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg hover:opacity-70 hover:bg-gray-100 focus:outline-none w-10 h-10 focus:bg-gray-100 focus:text-gray-700 md:hidden "
